import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as t}from"./index-gG8jtkCA.js";import"./index-QrriH-vD.js";import{M as a}from"./DocsRenderer-CFRXHY34-BaBGAxSb.js";import"./index-DI7CEG0L.js";import"./preview-DTuhema_.js";import"./iframe-CsWOmb8x.js";import"./react-18-DjTew52g.js";import"./index-CXQShRbs.js";function s(r){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(a,{title:"maxApi/Worklet"}),`
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-tsx",children:`const computeFibonacci = MaxApi.worklet.runOnBackgroundAsync('high', (n: number) => {
  'worklet';
  let prev = 0, curr = 1;
  for (let i = 2; i <= n; i++) {
    let next = prev + curr;
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-tsx",children:`const backgroundWorklet = MaxApi.worklet.runOnBackgroundAsync('high', (data: number[], target: number) => {
  'worklet';
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-tsx",children:`const regexWorklet = MaxApi.worklet.runOnBackgroundAsync('high', (text: string, patterns: string[]) => {
  'worklet';
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-ts",children:`const updateUI = MaxApi.worklet.runOnUI((x: number) => {
  // Update UI logic here
});
updateUI(5);
`})}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-tsx",children:`const showAlertOnUI = MaxApi.worklet.runOnUI((message: string) => {
  'worklet';
...
`]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Example:"}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-ts",children:`const fetchData = MaxApi.worklet.runOnJSThreadAsync(async (id: string) => {
...
`})}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-tsx",children:`const runHeavyTaskOnJSThread = MaxApi.worklet.runOnJSThreadAsync(async (input: number) => {
...
`]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Example:"}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-ts",children:`const processHeavyTask = MaxApi.worklet.runOnBackgroundAsync('high', (data) => {
  // Heavy computation
  return process(data);
});
...
`]}),`
`,n.jsx(e.hr,{})]})}function p(r={}){const{wrapper:e}={...t(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(s,{...r})}):s(r)}export{p as default};
